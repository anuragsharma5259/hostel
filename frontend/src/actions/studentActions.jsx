...
export const addStudent = (student) => async (dispatch, getState) => {
  try {
    ...
    console.log('addStudent action - userInfo:', userInfo);
    console.log('addStudent action - token:', userInfo?.token);
    ...
    console.log('addStudent action - config:', config);
    console.log('addStudent action - student payload:', student);
    ...
    console.error('addStudent action - error response:', error.response);
    dispatch({
